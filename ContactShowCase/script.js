document.addEventListener('DOMContentLoaded', () => {
    // API URL
    const API_URL = 'https://portfolio-lucky-io1t.onrender.com/api/contact/getcontacts';
    ...
    const markNewMessages = (messages) => {
        ...
        const previouslySeenIds = JSON.parse(localStorage.getItem('seenMessageIds') || '[]');
        ...
        if (hasNewMessages) {
            console.log(`New messages detected! Previous: ${previousCount}, Current: ${currentCount}`);
        }
